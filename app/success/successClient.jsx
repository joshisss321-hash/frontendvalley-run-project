...
//             <a
//               href="https://whatsapp.com/channel/0029VbCM5KOBVJl3FdMMHI3M"
//               target="_blank"
...
export default function SuccessClient() {
  ...
  const getEventDates = () => {
    ...
    if (eventData.dates.toLowerCase().includes("challenge")) {
      return eventData.dates;
    }

    return `The challenge will run from ${eventData.dates}`;
  };
  ...
  return (
    <main className="bg-gray-50 min-h-screen">
      ...
      <section className="py-24 px-6 max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-2xl font-bold text-red-600 mb-10">
          {loading ? "Loading Event..." : eventData?.title}
        </h2>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10 text-left space-y-6">
          ...
          <ul className="space-y-4 text-gray-700">
            ...
            <li>
              ...
              {eventData?.registrationDeadline || "Check your email"}
            </li>
            ...
            {/* ✅ FIXED DELIVERY LINE */}
            <li>
              ✔ Finisher medals will be delivered within 7 days after the challenge ends.
            </li>
