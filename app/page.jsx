...
//   const timeLeft = useCountdown(event.registrationDeadline);
//   const isExpired = event.registrationDeadline && new Date(event.registrationDeadline) <= new Date();
...
//   const resetTimer = () => {
//     clearInterval(timerRef.current);
//     timerRef.current = setInterval(() => setCurrent((p) => (p + 1) % total), 12000);
//   };
